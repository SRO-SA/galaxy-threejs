...
function(Constants) {
  ...
  class Orbit {
    constructor(object, color) {
      this._object = object;
      this._color = color || new THREE.Color('#000000');
    ...
    createOrbit() {
      var resolution = this._object.threeDistanceFromParent < 6000000000 ? this._object.threeDistanceFromParent + 15 * 50 : this._object.threeDistanceFromParent / 10000000; // segments in the line
